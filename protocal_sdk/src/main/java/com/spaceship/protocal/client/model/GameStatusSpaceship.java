...
public class GameStatusSpaceship {
    ...
    public GameStatusSpaceship board(List<List<String>> board) {
        this.board = board;
        return this;
    }

    public GameStatusSpaceship addBoardItem(List<String> boardItem) {
    ...
    public GameStatusSpaceship userId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GameStatusSpaceship gameStatusSpaceship = (GameStatusSpaceship) o;
        return Objects.equals(this.board, gameStatusSpaceship.board)
                && Objects.equals(this.userId, gameStatusSpaceship.userId);
    }
    ...
    public String toString() {
        ...
        sb.append("class GameStatusSpaceship {\n");
