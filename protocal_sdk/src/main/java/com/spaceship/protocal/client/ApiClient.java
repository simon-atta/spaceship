...
import com.spaceship.protocal.client.auth.ApiKeyAuth;
import com.spaceship.protocal.client.auth.Authentication;
import com.spaceship.protocal.client.auth.HttpBasicAuth;
import com.spaceship.protocal.client.auth.OAuth;
...
public class ApiClient {
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://localhost:8083/
     ...
     * @throws ProtocalApiException If fail to deserialize response body, i.e. cannot read response body
     *   or the Content-Type of the response is not supported.
     */
    @SuppressWarnings("unchecked")
    public <T> T deserialize(Response response, Type returnType) throws ProtocalApiException {
        ...
        if ("byte[]".equals(returnType.toString())) {
            ...
            try {
                ...
                throw new ProtocalApiException(e);
            }
        ...
        if (isJsonMime(contentType)) {
            ...
            throw new ProtocalApiException(
     ...
     * @throws ProtocalApiException If fail to serialize the given object
     */
    public RequestBody serialize(Object obj, String contentType) throws ProtocalApiException {
        if (obj instanceof byte[]) {
            ...
            throw new ProtocalApiException("Content type \"" + contentType + "\" is not supported");
        }
    }
     ...
     * @throws ProtocalApiException If fail to read file content from response and write to disk
     * @return Downloaded file
     */
    public File downloadFileFromResponse(Response response) throws ProtocalApiException {
        try {
     ...
     * @throws ProtocalApiException If fail to execute the call
     * @return ApiResponse&lt;T&gt;
     */
    public <T> ApiResponse<T> execute(Call call) throws ProtocalApiException {
     ...
     * @throws ProtocalApiException If fail to execute the call
     */
    public <T> ApiResponse<T> execute(Call call, Type returnType) throws ProtocalApiException {
        try {
    ...
    public <T> void executeAsync(Call call, final Type returnType, final ApiCallback<T> callback) {
        call.enqueue(new Callback() {
            ...
            public void onFailure(Request request, IOException e) {
                callback.onFailure(new ProtocalApiException(e), 0, null);
            }
     ...
     * @param returnType Return type
     * @throws ProtocalApiException If the response has a unsuccessful status code or
     *   fail to deserialize the response body
     * @return Type
     */
    public <T> T handleResponse(Response response, Type returnType) throws ProtocalApiException {
        if (response.isSuccessful()) {
            ...
            if (response.body() != null) {
                try {
                    ...
                    throw new ProtocalApiException(response.message(), e, response.code(), response.headers().toMultimap());
                }
            }
            throw new ProtocalApiException(response.message(), response.code(), response.headers().toMultimap(), respBody);
        }
    }
     ...
     * @throws ProtocalApiException If fail to serialize the request body object
     */
    public Call buildCall(String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams, String[] authNames, ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ProtocalApiException {
