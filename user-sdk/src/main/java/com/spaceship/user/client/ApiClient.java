...
package com.spaceship.user.client;
...
import com.spaceship.user.client.auth.ApiKeyAuth;
import com.spaceship.user.client.auth.Authentication;
import com.spaceship.user.client.auth.HttpBasicAuth;
import com.spaceship.user.client.auth.OAuth;
...
public class ApiClient {
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://localhost:8084/
     ...
     * @throws UserApiException If fail to deserialize response body, i.e. cannot read response body
     *   or the Content-Type of the response is not supported.
     */
    @SuppressWarnings("unchecked")
    public <T> T deserialize(Response response, Type returnType) throws UserApiException {
     ...
     * @throws UserApiException If fail to serialize the given object
     */
    public RequestBody serialize(Object obj, String contentType) throws UserApiException {
        if (obj instanceof byte[]) {
            ...
            throw new UserApiException("Content type \"" + contentType + "\" is not supported");
        }
    }
     ...
     * @throws UserApiException If fail to read file content from response and write to disk
     * @return Downloaded file
     */
    public File downloadFileFromResponse(Response response) throws UserApiException {
        try {
     ...
     * @throws UserApiException If fail to execute the call
     * @return ApiResponse&lt;T&gt;
     */
    public <T> ApiResponse<T> execute(Call call) throws UserApiException {
     ...
     * @throws UserApiException If fail to execute the call
     */
    public <T> ApiResponse<T> execute(Call call, Type returnType) throws UserApiException {
        try {
    ...
    public <T> void executeAsync(Call call, final Type returnType, final ApiCallback<T> callback) {
        call.enqueue(new Callback() {
            ...
            public void onFailure(Request request, IOException e) {
                callback.onFailure(new UserApiException(e), 0, null);
            }
     ...
     * @param returnType Return type
     * @throws UserApiException If the response has a unsuccessful status code or
     *   fail to deserialize the response body
     * @return Type
     */
    public <T> T handleResponse(Response response, Type returnType) throws UserApiException {
        if (response.isSuccessful()) {
            ...
            if (response.body() != null) {
                try {
                    ...
                    throw new UserApiException(response.message(), e, response.code(), response.headers().toMultimap());
                }
            }
            throw new UserApiException(response.message(), response.code(), response.headers().toMultimap(), respBody);
        }
    }
     ...
     * @throws UserApiException If fail to serialize the request body object
     */
    public Call buildCall(String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams, String[] authNames, ProgressRequestBody.ProgressRequestListener progressRequestListener) throws UserApiException {
